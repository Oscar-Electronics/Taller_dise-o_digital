...
## Botón de enviar (BTNC - botón central)
set_property PACKAGE_PIN N17 [get_ports btn_send]
set_property IOSTANDARD LVCMOS33 [get_ports btn_send]

## Botón de reset (BTNU - botón de arriba)  ← NUEVO
##set_property PACKAGE_PIN M18 [get_ports reset_n]
